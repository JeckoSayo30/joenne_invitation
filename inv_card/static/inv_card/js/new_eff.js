...
ScrollReveal().reveal('.sim00, .months', {delay:600, origin: 'left'});
ScrollReveal().reveal('.sim01', {delay:800, origin: 'right'});
ScrollReveal().reveal('.card', {delay:800, origin: 'bottom', interval:200});